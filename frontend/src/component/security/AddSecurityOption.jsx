// src/pages/admin/AddSecurityOption.jsx
import React, { useState } from "react";
import axios from "axios";
import { useNavigate } from "react-router-dom";
import { Plus, Trash2 } from "lucide-react";

export default function AddSecurityOption() {
 ...
 const handleSubmit = async (e) => {
  ...
  try {
    await axios.post(
      `${process.env.REACT_APP_BASE_URL}/api/security-options`,
      form
    );
    alert("Security Option created successfully");
    navigate("/security-options");
  } catch (err) {
    console.error(err);
    alert("Failed to create security option");
  }
};
